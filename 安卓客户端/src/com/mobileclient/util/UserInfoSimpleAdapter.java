...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*绑定该view各个控件*/
	  holder.tv_userInfoname = (TextView)convertView.findViewById(R.id.tv_userInfoname);
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_userInfoname.setText("用户名：" + mData.get(position).get("userInfoname").toString());
