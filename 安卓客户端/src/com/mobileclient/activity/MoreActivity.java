...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"选项信息","答卷信息","留言信息","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, SelectOptionListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, AnswerListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
