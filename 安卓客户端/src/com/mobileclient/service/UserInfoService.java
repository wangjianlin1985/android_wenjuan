...
public class UserInfoService {
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		params.put("userInfoname", userInfo.getUserInfoname());
	...
	public List<UserInfo> QueryUserInfo(UserInfo queryConditionUserInfo) throws Exception {
		...
		if(queryConditionUserInfo != null) {
			urlString += "&userInfoname=" + URLEncoder.encode(queryConditionUserInfo.getUserInfoname(), "UTF-8") + "";
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				userInfo.setUserInfoname(object.getString("userInfoname"));
	...
	public String DeleteUserInfo(String userInfoname) {
		HashMap<String, String> params = new HashMap<String, String>();
		params.put("userInfoname", userInfoname);
