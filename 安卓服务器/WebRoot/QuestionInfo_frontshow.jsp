...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>记录编号:</td>
    <td width=70%><%=questionInfo.getTitileId() %></td>
  </tr>

  <tr>
    <td width=30%>问卷名称:</td>
    <td width=70%>
      <%=questionInfo.getQuestionPaperObj().getQuestionPaperName() %>
    </td>
  </tr>

  <tr>
    <td width=30%>问题内容:</td>
    <td width=70%><%=questionInfo.getTitleValue() %></td>
  </tr>
