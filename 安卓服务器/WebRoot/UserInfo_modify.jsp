...
/*验证表单*/
function checkForm() {
    var userInfoname = document.getElementById("userInfo.userInfoname").value;
    if(userInfoname=="") {
        alert('请输入用户名!');
        return false;
    }
...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  <tr>
    <td width=30%>用户名:</td>
    <td width=70%><input id="userInfo.userInfoname" name="userInfo.userInfoname" type="text" value="<%=userInfo.getUserInfoname() %>" readOnly /></td>
  </tr>
  ...
  <tr>
    <td width=30%>性别:</td>
    <td width=70%><input id="userInfo.sex" name="userInfo.sex" type="text" size="3" value='<%=userInfo.getSex() %>'/></td>
  </tr>
  ...
  <tr>
    <td width=30%>邮箱地址:</td>
    <td width=70%><input id="userInfo.email" name="userInfo.email" type="text" size="40" value='<%=userInfo.getEmail() %>'/></td>
  </tr>

  <tr>
    <td width=30%>用户住址:</td>
    <td width=70%><input id="userInfo.address" name="userInfo.address" type="text" size="60" value='<%=userInfo.getAddress() %>'/></td>
  </tr>
