...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>记录编号:</td>
    <td width=70%><%=selectOption.getOptionId() %></td>
  </tr>

  <tr>
    <td width=30%>问题信息:</td>
    <td width=70%>
      <%=selectOption.getQuestionObj().getTitleValue() %>
    </td>
  </tr>

  <tr>
    <td width=30%>选项内容:</td>
    <td width=70%><%=selectOption.getOptionContent() %></td>
  </tr>
