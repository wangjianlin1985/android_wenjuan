...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>留言标题:</td>
    <td width=70%><input id="guestBook.title" name="guestBook.title" type="text" size="50" value='<%=guestBook.getTitle() %>'/></td>
  </tr>
  ...
  <tr>
    <td width=30%>留言人:</td>
    <td width=70%>
      <select name="guestBook.userObj.userInfoname">
      <%
        for(UserInfo userInfo:userInfoList) {
          String selected = "";
          if(userInfo.getUserInfoname().equals(guestBook.getUserObj().getUserInfoname()))
            selected = "selected";
      %>
