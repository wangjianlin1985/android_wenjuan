...
public class GuestBookAction extends BaseAction {
    ...
    public String AddGuestBook() {
        ActionContext ctx = ActionContext.getContext();
        try {
            UserInfo userObj = userInfoDAO.GetUserInfoByUserInfoname(guestBook.getUserObj().getUserInfoname());
    ...
    public String QueryGuestBookOutputToExcel() { 
        ...
        for(int i=0;i<guestBookList.size();i++) {
        	...
        	dataset.add(new String[]{guestBook.getTitle(),guestBook.getContent(),guestBook.getUserObj().getName(),
